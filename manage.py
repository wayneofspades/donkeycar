...
def drive(cfg, model_path=None, use_joystick=False, model_type=None, camera_type='REALSENSE', meta=[] ):
    '''
    ...
    '''
    print("camera_type val", camera_type)
    if cfg.DONKEY_GYM:
    ...
    if camera_type == "REALSENSE":
        print("LAUNCHING REALSENSE ROS CAM")
